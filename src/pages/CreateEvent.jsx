  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image src={eventCreated.cover} maxWidth="820px" maxHeight="410px" />
          <Button m="16px auto 0px auto" color={"black"} onClick={onOpen}>
            {" "}
            Change Cover Photo{" "}
          </Button>
          {isOpen && (
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Tabs variant={"unstyled"} alignContent={"center"} isFitted>
                      <TabList
                      ...
                      <TabPanels>
                        ...
                        <TabPanel>
                          <div maxWidth="1000px">
                            <Text m="0 0 16px">
                              Once you link your Zoom account, we can
                              automatically generate Zoom meetings for you.
                            </Text>
                            <Button
                              background={"#2D8CFF"}
                              padding={"10px 14px"}
                            ...
                            >
                              <Text>
                                Or you can enter the meeting information:{" "}
                              </Text>
                            </div>
                            <div>
                              <FormControl
                              ...
                              <FormLabel mt="16px">Zoom meeting ID</FormLabel>
                              <Input
                                id="input-meeting-id"
                                type="number"
                                maxWidth={"320px"}
                              ...
                              <InputGroup maxWidth={"320px"} size={"md"}>
                                <Input
                        ...
                        <TabPanel>
                          <div>
                            <FormControl>
                              ...
                              <FormHelperText>
                                Google Meet, Twitch, Youtube, Discord, wherever
                                it is.
                              </FormHelperText>
                            </FormControl>
                          </div>
                  ...
                  >
                    <Tabs variant={"unstyled"} alignContent={"center"} isFitted>
                      ...
                      <TabPanels>
                        ...
                        <TabPanel>
                          <div maxWidth="1000px">
                            Event Series is under development, please wait for
                            us!
                          </div>
                        </TabPanel>
                      </TabPanels>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      <Text fontSize="16px" m="0px 0px 2px 8px">
                        {" "}
                      ...
                      >
                        {" "}
                        If selected, only approved guests will receive a ticket.{" "}
                      </Text>
                    </Checkbox>
                  </div>
                </div>
                ...
                >
                  <Button
                    ...
                    isDisabled={
                      eventCreated.name == "" ||
                      (eventCreated.type.event_type == "IN_PERSON" &&
                        eventCreated.type.location == "") ||
                      (eventCreated.type.event_type == "ZOOM" &&
                        eventCreated.type.zoom_password == "" &&
                        eventCreated.type.zoom_id == "" &&
                        eventCreated.type.zoom_url == "") ||
                      (eventCreated.type.event_type == "VIRTUAL" &&
                        eventCreated.type.event_url == "") ||
