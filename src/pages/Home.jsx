...
export default function Home() {
  return (
    ...
    >
      ...
      <div style={{
        paddingTop: "96px",
        background: "linear-gradient(rgba(174, 47, 206, 0.2) 0%, rgba(232, 115, 55, 0.1) 52.58%, rgba(153, 93, 8, 0) 100%)"
      }}></div>
      <div
        style={{
          display: "block",
          ...
          <TabList style={{
            ...
            <div style={{
              ...
              <Tab
                ...
                _selected={{ color: 'white', bg: 'blue.500' }}>Upcoming</Tab>
              <Tab
                p="8px 16px"
